...
def load_assets():
    ...
    btns[Selecionar] = [pygame.image.load(os.path.join(Botoes, 'Selecionar1.png')).convert(),pygame.image.load(os.path.join(Botoes, 'Selecionar2.png')).convert_alpha()]
    btns[Selecionar] = [pygame.transform.scale(btns[Selecionar][0], (100, 100)), pygame.transform.scale(btns[Selecionar][1], (100, 100))]
    btns[BSkins] = [pygame.image.load(os.path.join(Botoes, 'Skins1.png')).convert(),pygame.image.load(os.path.join(Botoes, 'Skins2.png')).convert_alpha()]
    btns[BSkins] = [pygame.transform.scale(btns[BSkins][0], (100, 100)),pygame.transform.scale(btns[BSkins][1], (100, 100))]
    btns[Upgrade] = [pygame.image.load(os.path.join(Botoes, 'Upgrade1.png')).convert(),pygame.image.load(os.path.join(Botoes, 'Upgrade2.png')).convert_alpha()]
